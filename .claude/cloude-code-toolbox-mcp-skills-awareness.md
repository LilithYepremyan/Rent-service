...
_Generated: 2026-06-05T12:47:18.644Z_
...
Workspace `mcp.json` _(folder: rent-service)_

- **c:\Users\user\Desktop\rent-service\.mcp.json** — _File missing_
...
- **pr-description** — `C:\Users\user\.claude\skills\pr-description`
  - Use this skill when I need to create or improve a pull request description.
